...
unordered_map<std::pair<int,int>,int, boost::hash<std::pair<int,int>>> ref_read_counts;
std::unordered_map<int,int> seen_comb;
std::unordered_map<int,int> comb_count;
Caller::Caller(std::string &reference, int k, double epsilon, int window){
	this->k=k;
