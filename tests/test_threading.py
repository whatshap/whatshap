...
def create_testinstance1():
	...
	for i in range(len(matrix)):
		...
		for j in range(len(matrix[i])):
			if matrix[i][j] != " ":
				read.add_variant(var_pos[j], int(matrix[i][j]), [(1-int(matrix[i][j]))*30, int(matrix[i][j])*30])
		readset.add(read)
		
	clustering = [[0, 4, 6], [1, 2], [7, 10, 13], [9, 12, 14], [3, 5, 8, 11], [15, 16], [17], [18]]
	genotypes = [{0:2, 1:1}, {0:2, 1:1}, {0:2, 1:1}, {0:1, 1:2}, {0:2, 1:1}, {0:2, 1:1}, {0:2, 1:1}, {0:2, 1:1}, {0:2, 1:1}, {0:3, 1:0},   {0:2, 1:1}, {0:2, 1:1}, {0:2, 1:1}, {0:1, 1:2}, {0:2, 1:1}, {0:2, 1:1}, {0:1, 1:2}, {0:2, 1:1}, {0:1, 1:2}, {0:2, 1:1},    {0:2, 1:1}, {0:2, 1:1}]
...
def test_cut_positions():
	path = [[2,3,5,1], [2,3,5,1], [2,3,6,1], [2,3,6,1], [4,8,6,1], [5,8,6,1], [5,8,6,1], [5,8,6,6], [8,8,6,6], [8,8,6,7], [8,8,6,7], [8,8,9,10], [8,11,9,10], [8,11,9,10]]
...
def test_multiswitch_improvement():
	...
	truth = [[3,1,2,4], [3,1,2,4], [5,1,2,4], [5,1,2,4], [5,6,7,4], [5,6,7,4], [5,6,7,7], [5,6,7,4], [5,6,7,4], [10,8,9,4], [10,8,9,4]]
