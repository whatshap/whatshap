...
def test_phasing_to_reads():
	for filename in ['tests/data/phased-via-HP.vcf', 'tests/data/phased-via-PS.vcf']:
		...
		assert read[0].allele[0] == 1
		assert read[0].quality[0] == 23
		assert read[1].position == 350 - 1
		assert read[1].allele[0] == 0
		assert read[1].quality[0] == 42
		...
		assert read1[0].allele[0] == 0
		assert read1[0].quality[0] == 10
		assert read1[1].position == 150 - 1
		assert read1[1].allele[0] == 1
		...
		assert read2[0].allele[0] == 0
		assert read2[0].quality[0] == 30
		assert read2[1].position == 350 - 1
		assert read2[1].allele[0] == 0
		assert read2[1].quality[0] == 91
		...
		assert read[0].position == 300 - 1
		assert read[0].allele[0] == 0
		assert read[0].quality[0] == 30
		assert read[1].position == 350 - 1
		assert read[1].allele[0] == 0
		assert read[1].quality[0] == 91
