...
from whatshap.test import readselection_2
...
def test_selection():
	reads = string_to_readset("""
	  ...
	  1    1
	""")
	selected_reads, new_components, stats = readselection_2(reads, max_cov = 1, bridging = False)
	assert selected_reads == set([1,5])
	selected_reads, new_components,stats = readselection_2(reads, max_cov = 2, bridging = False)
	assert selected_reads == set([1,3,5]), str(selected_reads)
	selected_reads, new_components ,stats= readselection_2(reads, max_cov = 3, bridging = False)
	assert selected_reads == set([1,3,5,7]), str(selected_reads)
	selected_reads, new_components, stats = readselection_2(reads, max_cov = 3, bridging = True)
...
def test_selection2():
	reads = string_to_readset("""
	  1111
	    ...
	    1      11
	""")
	selected_reads, new_components,stats = readselection_2(reads, max_cov = 4, bridging = False)
...
def test_bridging():
	...
	selected_reads, new_components,stats = readselection_2(reads, max_cov = 2, bridging= True)
...
def test_tuple_scores():
	...
	selected_reads, new_components,stats = readselection_2(rs, max_cov = 2, bridging= False)
	selected_reads, new_components,stats = readselection_2(rs, max_cov = 2, bridging= True)
