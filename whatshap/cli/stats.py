    ...
    def get_detailed_stats(self, chr_lengths: Optional[Dict[str, int]] = None) -> DetailedStats:
        ...
        if block_sizes:
            return DetailedStats(
                ...
                variant_per_block_avg=sum(block_sizes) / len(block_sizes) if len(block_sizes) else float("nan"),
                ...
                bp_per_block_avg=sum(block_lengths) / len(block_lengths) if len(block_lengths) else float("nan"),
                ...
                phased_fraction=sum(block_sizes) / self.heterozygous_variants if self.heterozygous_variants else float("nan"),
                phased_snvs_fraction=phased_snvs / self.heterozygous_snvs if self.heterozygous_snvs else float("nan"),
