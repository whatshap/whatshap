...
from .align import edit_distance, edit_distance_affine_gap, needle, enumerate_all_kmers, split, enumerate_a_kmer
...
class ReadSetReader:
    ...
    def realign(
        ...
        if alt_temp in seen_splits:
            ...
            #alt=split(alt_temp,int(kmersize))
        ...
        if use_affine:
            ...
            #print(ref_temp,'\t',alt_temp, '\t', query_temp,'\t',len(query_temp), '\t', distance_ref,'\t',distance_alt)
